...
@allure.title("Add user with only existed Phone number and new email/personal data. Check that old data for this Phone uploaded")
@pytest.mark.parametrize('username, password, code', [
    (USERNAME_BA, PASSWORD_BA, CODE)])
def test_case(setup, username, password, code):
    """
    [Building/Units/Any unit from the list/Users] Add user with only existed Phone number and new email/personal data.
     Check that old data for this Phone uploaded
    """
